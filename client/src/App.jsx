...
function App() {
  ...
  async function handleTokenize() {
    try {
      const data = await sendRequest('http://localhost:5656/api/tokenize', {
        method: 'POST',
      ...
      // Update history after tokenization
      const updatedHistory = await sendRequest('http://localhost:5656/api/history');
